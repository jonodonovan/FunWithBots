...
<html lang="en" dir="ltr">
	...
	<body>
        # FunWithBots PRIVACY POLICY

        Last Revised: 2018-01-06
        ...
        * To enforce applicable user agreements or policies, including our [Terms of Service](https://github.com/abraham/FunWithBots-tos/blob/master/terms.md); and to protect us, our users or the public from harm or illegal activities;
        * In connection with any merger, sale of FunWithBots assets, financing or acquisition of all or a portion of our business to another company; and
        * If we notify you through our services (or in our privacy policy) that the information you provide will be shared in a particular manner and you provide such information.
        ...
        California law permits residents of California to request certain details about how their information is shared with third parties for direct marketing purposes.  If you are a California resident and would like to make such a request, please contact us at [email@jodonovan.com](mailto:email@jodonovan.com).  However, please note that under the law, Services such as ours that permit California residents to opt in to, or opt out of, this type of sharing are not required to provide such information upon receiving a request, but rather may respond by notifying the user of his or her right to prevent the disclosure.  To opt out of having information about you shared with third parties for direct marketing purposes, please email [email@jodonovan.com](mailto:email@jodonovan.com).

        ## Contact Us

        If you have any questions about this privacy policy, please contact us at:  [email@jodonovan.com](mailto:email@jodonovan.com).
    </body>
</html>
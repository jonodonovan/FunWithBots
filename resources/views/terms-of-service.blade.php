...
<html lang="en" dir="ltr">
	...
	<body>
        # FunWithBots TERMS OF SERVICE

        Last Updated: 2018-01-06

        These terms of service ("Terms") apply to your access and use of FunWithBots (the "Service"). Please read them carefully.
        ...
        For information about how we collect and use information about users of the Service, please check out our [privacy policy](https://github.com/abraham/FunWithBots-tos/blob/master/privacy.md).
        ...
        * Circumvent or attempt to circumvent any filtering, security measures, rate limits or other features designed to protect the Service, users of the Service, or third parties.
        ...
        FunWithBots makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.
        ...
        IN NO EVENT WILL FunWithBots BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO FunWithBots. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.
        ...
        These Terms constitute the entire agreement between you and FunWithBots regarding the use of the Service, superseding any prior agreements between you and FunWithBots relating to your use of the Service.
        ...
        Questions or comments about the Service may be directed to us at the email address [email@jodonovan.com](mailto:email@jodonovan.com).
    </body>
</html>
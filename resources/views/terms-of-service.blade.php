...
<html lang="en" dir="ltr">
	...
	<body>
        <h1>FunWithBots TERMS OF SERVICE</h1>

        <p>Last Updated: 2018-01-06</p>

        <p>These terms of service ("Terms") apply to your access and use of FunWithBots (the "Service"). Please read them carefully.</p>

        <h2>Accepting these Terms</h2>

        <p>If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don't agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing <a href="mailto:email@jodonovan.com">email@jodonovan.com</a>.</p>
        ...
        <p>Whenever we make changes to these Terms, the changes are effective immediately after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check FunWithBots for changes to these Terms.</p>
        ...
        <p>For information about how we collect and use information about users of the Service, please check out our <a href="https://funwithbots.jodonovan.com/privacy-policy">https://funwithbots.jodonovan.com/privacy-policy</a>.</p>
        ...
        <p>FunWithBots makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.</p>
        ...
        <p>IN NO EVENT WILL FunWithBots BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO FunWithBots. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.</p>
        ...
        <p>These Terms constitute the entire agreement between you and FunWithBots regarding the use of the Service, superseding any prior agreements between you and FunWithBots relating to your use of the Service.</p>

        <h2>Feedback</h2>

        <p>Please let us know what you think of the Service, these Terms and, in general, FunWithBots. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, FunWithBots, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.</p>

        <h2>Questions & Contact Information</h2>

        <p>Questions or comments about the Service may be directed to us at the email address <a href="mailto:email@jodonovan.com">email@jodonovan.com</a>.</p>
    </body>
</html>